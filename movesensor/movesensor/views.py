...
def infnum(dic):
    return dic["ax"] ** 2 + dic["ay"] ** 2 + dic["az"] ** 2
...
def t4():
    # mouse_click(1024,470)
    input = [["w"], ["s"], ["d"], ["a"], ["j"], ["k"], ["l"], ["j"], ["k"], ["l"], ["u"], ["i"], ["o"], ["left_arrow"],
             ["right_arrow"], ["up_arrow"], ["down_arrow"], ["x"], ["c"], ["v"], ["b"], ["n"],
             ["m"], ["x"], ["c"], ["v"], ["j", "k"], ["x", "c"], ["j", "l"], ["k", "l"], ["x", "v"], ["c", "v"]]
    a = input[random.randint(0, len(input) - 1)]
    key_input(["left_arrow"]);
    b = input[random.randint(0, len(input) - 1)]
    key_input(["s"])
    key_input(b)
    key_input(a)
